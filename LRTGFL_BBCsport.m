...
% [V,Eval,f,P,R,nmi,avgent,AR,ACC,C] = baseline_spectral_onRW_acc(SS,cls_num,gt,projev);
% fprintf('lambda=%f, F=%f, P=%f, R=%f, nmi score=%f, avgent=%f,  AR=%f, ACC=%f,\n',lambda1,f(1),P(1),R(1),nmi(1),avgent(1),AR(1),ACC(1));
% 
