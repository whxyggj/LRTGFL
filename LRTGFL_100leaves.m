...
% plt = 1:1:iter;
% figure
% plot(plt,Obj,'r*-','LineSmoothing','on');
% % legend('Obh');
% set(gca,'FontName','Times New Roman','FontSize',14,'FontWeight','normal');
% xlabel('Iteration', 'FontName','Times New Roman','FontSize',14,'FontWeight','normal')  %x÷·◊¯±Í√Ë ˆ
% ylabel('Object Value', 'FontName','Times New Roman','FontSize',14,'FontWeight','normal') %y÷·◊¯±Í√Ë ˆ
